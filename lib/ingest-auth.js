...
async function authorizeIngestRequest(req, env = process.env, { schedulerJob, fetchImpl, now } = {}) {
  ...
  if (schedulerJob) return authorizeScopedSchedulerRequest(req, schedulerJob, env, routeSecrets, { fetchImpl, now });
